...
public class Methods {
	...
	public static void drawBullsEye(double x, double y, double radius) {
		...
		StdDraw.filledCircle(x, y, radius*(3.0/4.0)); //Blue ring with 3.0/4.0 the radius
		...
		StdDraw.filledCircle(x, y, radius*(1.0/2.0)); // Red ring with 1.0/2.0 of the radius
		

		
		StdDraw.setPenColor(255,255,109); 
		StdDraw.filledCircle(x, y, radius*(1.0/4.0)); //Yellow ring with 1.0/4.0 of the radius
